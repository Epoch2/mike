  ...
  NetServer = (function() {
    ...
    function NetServer(config) {
      var server,
        _this = this;
      this.config = config;
      this.authenticateUser = function(client) {
        return NetServer.prototype.authenticateUser.apply(_this, arguments);
      };
      this.handleClientRequest = function(client, request) {
        return NetServer.prototype.handleClientRequest.apply(_this, arguments);
      };
      this.addIDTo = function(client) {
        return NetServer.prototype.addIDTo.apply(_this, arguments);
      };
