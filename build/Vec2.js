...
(function() {
  MC.Vec2 = (function() {
    ...
    Vec2.prototype.sqrt = function() {
      return new MC.Vec2(Math.sqrt(this.x), Math.sqrt(this.y));
    };

    Vec2.prototype.sqrd = function() {
      return new MC.Vec2(this.x * this.x, this.y * this.y);
    };
    ...
    Vec2.prototype.unit = function() {
      ...
      len = this.length();
      return new MC.Vec2(this.x / len, this.y / len);
    };
    ...
    Vec2.prototype.copy = function() {
      return new MC.Vec2(this.x, this.y);
    };
    ...
    Vec2.prototype.plus = function(vec) {
      return new MC.Vec2(this.x + vec.x, this.y + vec.y);
    };
    ...
    Vec2.prototype.times_s = function(scalar) {
      return new MC.Vec2(this.x * scalar, this.y * scalar);
    };
    ...
    Vec2.prototype.devide_v = function(vec) {
      this.x /= vec.x;
      this.y /= vec.y;
      return void 0;
    };

    Vec2.prototype.devide_s = function(scalar) {
      this.x /= scalar;
      this.y /= scalar;
      return void 0;
    };

    Vec2.prototype.devidedWith_v = function(vec) {
      return new MC.Vec2(this.x / vec.x, this.y / vec.y);
    };

    Vec2.prototype.devidedWith_s = function(scalar) {
      return new MC.Vec2(this.x / scalar, this.y / scalar);
    };
    ...
    Vec2.prototype.perpCCW = function() {
      return new MC.Vec2(-this.y, this.x);
    };
    ...
    Vec2.prototype.rotated = function(tiltAngle) {
      ...
      angle -= tiltAngle;
      len = this.length();
      return new MC.Vec2(len * Math.cos(angle), len * Math.sin(angle));
    };
